...
import AddAttributes from "@src/components/attributes/AddAttributes";
import AttributeDetails from "@src/components/attributes/AttributeDetails";
...
class Attributes extends Component {
	...
	filterAttribute = () => {
		...
		const filteredAttributes = this.props.attributes.filter(att => isContains(att.name, searchCriteria) || isContains(att.type, searchCriteria));
			...
			<div className="attributes-container">
...

				{
					<AttributeDetails
						...
						updateAttribute={this.props.handleAttribute}
						removeAttribute={this.props.handleAttribute}
					/>
				}

				{!bannerflag && this.props.attributes.length < 1 && (
					<Banner
