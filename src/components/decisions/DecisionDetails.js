...
import ViewAttribute from "@src/components/attributes/ViewAttributes";
				...
				{transformedData &&
					transformedData.map((data, caseIndex) => (
						<div
							...
							key={`case - ${caseIndex} - ${decisionIndex}`}
						>
							<div className="tool-flex">
								<div>
									<a
										href=""
										onClick={e => this.editCondition(e, data.index)}
									>
								...
								<div>
									<a
										href=""
										onClick={e => this.handleRemoveCondition(e, data.index)}
									>
		...
		const conditions = Object.keys(outcomes).map((key, index) => (
			<div key={key}>
				<PanelBox className={"boolean"}>
					...
					<div className="type">
						conditions <span className="type-badge">{outcomes[key].length}</span>
					</div>
					<div className="menu">
						<a
							href=""
						...
						<a
							href=""
							onClick={e => this.handleRemoveConditions(e, String(key))}
						>
							Remove
						</a>
					</div>
